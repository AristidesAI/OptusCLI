    ...
    return (
      n.length > 1 &&
        (function (e) {
          if ('6' !== e[1])
            throw new Error(
              "Got '${salt}' but only SHA512 ($6$) algorithm supported"
            );
        })(n),
      (i = n[2] ? parseInt(n[2].split('=')[1]) : NaN),
      i ? (i < 1e3 && (i = 1e3), i > 999999999 && (i = 999999999), (t = n[3] || t)) : (t = n[2] || t),
      (function (e) {
        if (e.length < 8 || e.length > 16)
          throw new Error(
            "Wrong salt length: '${salt.length}' bytes when 8 <= n <= 16 expected. Got salt '${salt}'."
          );
      })(t),
      (function (e, t, i, n, a) {
        return (
          e.length > 2 && (t = i ? '$6$rounds=' + i + '$' : '$6$'),
          t + n + '$' + a
        );
      })(
        n,
        ...
        (function (e, t, i) {
          ...
          for (n = 0; n < e.length; n += 3) {
            ...
            if (void 0 === t[n + 1])
              ...
              (r = e.charCodeAt(t[n]) & parseInt('00111111', 2)),
                (s =
                  ((e.charCodeAt(t[n]) & parseInt('11000000', 2)) >>> 6) |
                  ((e.charCodeAt(t[n + 1]) & parseInt('00001111', 2)) << 2)),
                (O =
                  ((e.charCodeAt(t[n + 1]) & parseInt('11110000', 2)) >> 4) |
                  ((e.charCodeAt(t[n + 2]) & parseInt('00000011', 2)) << 4)),
          ...
          (function (e, t, i) {
            const n = (function (e, t) {
              ...
              let a,
                r = e + t + g(i, e.length);
              for (a = n; a > 0; a >>= 1) r += 0 != (1 & a) ? i : e;
              return T(r);
            })(e, t);
            let a,
              r = '';
            for (a = 0; a < e.length; a++) r += e;
            const s = g(T(r), e.length);
            let O,
              o = '';
            for (O = 0; O < 16 + n.charCodeAt(0); O++) o += t;
    ...
    (function (e, t) {
      null == O &&
        (O = new Array(
          ...
          new D(-176337325, 294109702),
          new D(81841820, 575399051),
          new D(-85945611, -1043266807),
          new D(-536766208, 1531048810),
          new D(1657949876, 412946034),
          new D(-152721809, 328858917),
          new D(-43400207, -1690135813),
          new D(-1121658204, 981583801),
          new D(-64696763, 119178574),
          new D(-16787817, -243218451),
          new D(-49000382, -1753700033),
          new D(654380690, 145716980),
          new D(-1567716228, -1220411728),
          new D(-1082752817, 573934940)
        ));
      const i = new Array(
      ...
      for (z = 0; z < 8; z++) (M[2 * z] = i[z].h), (M[2 * z + 1] = i[z].l);
      return M;
    })(
      (function (e) {
...
function m(e, t, i, n, a) {
  const r =
      (65535 & t.l) + (65535 & i.l) + (65535 & n.l) + (65535 & a.l),
    s =
      (t.l >>> 16) +
      (i.l >>> 16) +
      (n.l >>> 16) +
    ...
    o =
      ...
      (a.h >>> 16) +
      (O >>> 16);
  (e.l = (65535 & r) | (s << 16)), (e.h = (65535 & O) | (o << 16));
}
function E(e, t, i, n, a, r) {
  const s =
    ...
    l =
      ...
      (r.h >>> 16) +
      (o >>> 16);
  (e.l = (65535 & s) | (O << 16)), (e.h = (65535 & o) | (l << 16));
}
function h(e, t, i) {
  ...
  (e.l = (65535 & n) | (a << 16)), (e.h = (65535 & r) | (s << 16));
}
function g(e, t) {
  let i,
    n = '';
  for (i = 0; i < Math.floor(t / 64); i++) n += e;
  return (n += e.substr(0, t % 64)), n;
}

function lpad(e, t, i) {
  i = i || 2;
  let n = e.toString();
  for (; n.length < i; ) n = t + n;
  return n;
}
